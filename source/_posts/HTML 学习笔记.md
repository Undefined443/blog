...
[标记日期和时间 | MDN][marking up times and dates]
...
[文档与网站结构 | MDN](https://developer.mozilla.org/zh-CN/docs/Learn/HTML/Introduction_to_HTML/Document_and_website_structure)
...
[分辨率切换 | MDN][resolution switching]
...
[其他 \<video\> 属性 | MDN][other video features]

[显示音轨文本 | MDN][displaying video text tracks]
...
[其他嵌入技术 | MDN][other embedding technologies]

...
参考：[Persisting data | Docker Docs](https://docs.docker.com/get-started/05_persisting_data/)
...
- [Language-specific guides | Docker Guides](https://docs.docker.com/language/)
...
参考：[Use bind mounts | Docker Docs](https://docs.docker.com/get-started/06_bind_mounts/)
...
参考：[Run your app in a development container | Docker Docs](https://docs.docker.com/get-started/06_bind_mounts/#run-your-app-in-a-development-container)

了解更多高级存储概念，查阅 [Manage data in Docker | Docker Docs](https://docs.docker.com/storage/) 。

### Docker Compose

- [Multi-container apps | Docker Docs](https://docs.docker.com/get-started/07_multi_container/)

- [Docker Compose | Docker Manuals](https://docs.docker.com/compose/gettingstarted/)

- [Docker Compose 工具 | 阮一峰的网络日志](https://www.ruanyifeng.com/blog/2018/02/docker-wordpress-tutorial.html)
...
参考：[Use Docker Compose | Docker Docs](https://docs.docker.com/get-started/08_using_compose/)
...
- [Ports | Docker Docs](https://docs.docker.com/compose/compose-file/compose-file-v3/#ports)
...
参考：[Multi-platform builds | Docker Docs](https://docs.docker.com/build/building/multi-platform/#getting-started)
...
参见：[Image-building best practices | Docker Docs](https://docs.docker.com/get-started/09_image_best/)
...
参考：[.dockerignore file | Docker Docs](https://docs.docker.com/engine/reference/builder/#dockerignore-file)
...
- [3 Simple Tricks for Smaller Docker Image | infoq](https://www.infoq.cn/article/3-simple-tricks-for-smaller-docker-images)

- [Dockerfile 多阶段构建 | yeasy](https://yeasy.gitbook.io/docker_practice/image/multistage-builds)
...
2. 在 Docker CLI 中登录到 GitHub Container Registry
   ...
   > 将 `<your_token>` 和 `<username>` 替换为你自己的 GitHub Token 和 GitHub 用户名
...
参考：[fatal error: Python.h: No such file or directory | Stack Overflow](https://stackoverflow.com/questions/21530577/fatal-error-python-h-no-such-file-or-directory)

> [What is .build-deps for apk add --virtual command | Stack Overflow](https://stackoverflow.com/questions/46221063/what-is-build-deps-for-apk-add-virtual-command)
...
[Shared Drives | Docker Docs](https://docs.docker.com/docker-for-windows/#shared-drives)

进入设置：Resources > File sharing，添加要共享的目录。

如果没有该设置项，检查 General 下的 `Use the WSL 2 based engine`，确保取消勾选。

![image](https://s2.loli.net/2024/08/11/lh3BzUs4RP51pCi.png)

### host 网络模式

巨坑！host 网络模式只支持 Linux。不支持 Windows 和 macOS。

[Networking using the host network](https://docs.docker.com/network/network-tutorial-host/): The host networking driver only works on Linux hosts, and is not supported on Docker Desktop for Mac, Docker Desktop for Windows, or Docker EE for Windows Server.

![image](https://s2.loli.net/2024/08/11/hX4BvYecD6wWEMs.png)
